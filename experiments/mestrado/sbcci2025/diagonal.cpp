...
int main()  // NOLINT
{
    ...
    static const std::string folder = fmt::format("{}mestrado/sbcci2025/gates/", EXPERIMENTS_PATH);
    ...
    for (const auto mu : mus ) {
        ...
        for (const auto& [gate, truth_table] : gates)
        {
            ...
            op_domain_params.operational_params.simulation_parameters     = sim_params_old;
            op_domain_params.operational_params.sim_engine                = sidb_simulation_engine::CLUSTERCOMPLETE;        //  2                          { 1.5, 1.9 }    - para meu fio qca
            // op_domain_params.operational_params.input_bdl_iterator_params = bdl_input_iterator_params{ detect_bdl_wires_params {3, detect_bdl_pairs_params { 2.3, 2.9 }}, bdl_input_iterator_params::input_bdl_configuration::PERTURBER_DISTANCE_ENCODED};
